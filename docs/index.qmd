  ...
  dashboard:
    ...
    nav-buttons:
      ...
      - icon: info-circle
        href: howto.html
      - icon: github
        href: https://github.com/Birmingham-and-Solihull-ICS/ParamedicsFeedback
      - icon: inbox
        href: contact.html
execute:
  enabled: true
...
Click the next page number and 'Data' tab to navigate through the data on different pages.
