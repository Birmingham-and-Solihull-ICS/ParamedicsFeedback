    ...
    dashboard:
        ...
        nav-buttons:
            - icon: house-door-fill
              href: UserInfo.html
            - icon: github
              href: https://github.com/Birmingham-and-Solihull-ICS
            - icon: info-circle
              href: howto.html
...
def plot_bar_chart(data, column, title):
    ...
    fig.update_traces(textposition="outside", textangle=0, cliponaxis=False, textfont_size=11)
    fig.update_layout(
...
```{python}
#| title: The Most Frequent Uni-grams
plot_wordcloud(Q1_word_counts)
```


```{python}
#| title: The Most Frequent Bi-grams
